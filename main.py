...
for i in range(16):
    ...
    rect_trees[i] = rect_trees[i].move(random.random() * size[0], size[1] * random.random())
...
while 1:
    ...
    pygame.draw.ellipse(screen, (128,128,128), (30, 30, 900, 660)) #TODO: remove those magic numbers
    ...
    pygame.draw.line(screen, 'red', car_rect.center, (car_rect.center[0] + speed[0]*400, car_rect.center[1] + speed[1] *400))
